...
Creates draft emails in Outlook for review - DOES NOT SEND
"""
...
def create_all_drafts():
    ...
    try:
        print("="*80)
        print("CREATING DRAFTS FOR ALL OVERDUE ORDERS")
        print("="*80)
        ...
        # Create drafts for each order
        print(f"\n[INFO] Creating {len(orders)} draft email(s)...\n")
        ...
        for i, order in enumerate(orders, 1):
            ...
            # Save as draft (don't display yet)
            mail.Save()
        ...
        print("="*80)
        print(f"ALL {len(created_drafts)} DRAFTS CREATED SUCCESSFULLY")
        print("="*80)
        
        print("\n[INFO] Draft emails have been saved to your Outlook Drafts folder")
        print("\nSUMMARY:")
        for i, draft in enumerate(created_drafts, 1):
            print(f"\n{i}. Order #{draft['order_id']}")
            print(f"   TO: {draft['to']} ({draft['carrier']})")
            if draft['cc']:
                print(f"   CC: {draft['cc']}")
        ...
        print("NEXT STEPS:")
        print("="*80)
        print("1. Open Outlook and go to your Drafts folder")
        print("2. Review each draft email")
        print("3. Make any edits if needed")
        print("4. Send when ready")
        print("\n[IMPORTANT] No emails have been sent - they are all in your Drafts folder")
        
    except Exception as e:
        print(f"\n[ERROR] Failed to create drafts: {e}")
